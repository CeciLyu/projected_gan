...
#SBATCH --output=slurm-%j-dis_attn_res_32.out
...
tensorboard --logdir=/home/suyuelyu/scratch/proteinGAN/pro_out/00014-fastgan_lite-pro_training_data_wo_X_21_pos_ecd-gpus1-batch64-dis_attn_res_32_pos_ecd/ --host 0.0.0.0 --load_fast false &
