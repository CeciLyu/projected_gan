...
#SBATCH --time=1:30:00         # adjust this to match the walltime of your job
#SBATCH --nodes=1      
#SBATCH --ntasks=1
...
DATA_DIR=/home/suyuelyu/scratch/proteinGAN/pro_training_data_wo_X_21_spread_out
REPO_DIR=/scratch/suyuelyu/proteinGAN/projected_gan 
OUTPUT_DIR=/scratch/suyuelyu/proteinGAN/pro_out

tensorboard --logdir=/home/suyuelyu/scratch/proteinGAN/pro_out --host 0.0.0.0 --load_fast false &
python ${REPO_DIR}/train.py \
    ...
    --d_attn_res=16 \
    --attn_res=32 \
    --desc=res_gen_32_dis_16_spread_out_sparse_loss_1