...
class ProjectedGANLoss(Loss):
    ...
    def accumulate_gradients(self, phase, real_img, real_c, gen_z, gen_c, gain, cur_nimg, scaler = None):
        ...
        if do_Gmain:
            ...
            with torch.autograd.profiler.record_function('Gmain_backward'):
                scaler_Gmain.scale(loss_Gmain).backward()
        ...
        if do_Dmain:
            ...
            with torch.autograd.profiler.record_function('Dgen_backward'):
                scaler_Dgen.scale(loss_Dgen).backward()
            ...
            with torch.autograd.profiler.record_function('Dreal_backward'):
                scaler_Dreal.scale(loss_Dreal).backward()
